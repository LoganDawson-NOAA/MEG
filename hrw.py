...
HiResModels = ['NAM3','HIRE','HRRR','HREF','FV3S','FV3N']
FV3CAMs = ['FV3SAR','FV3SARX','FV3NEST','FV3SARDA']
...
state_domains = ['OK','Louisiana','DC-NYC']
...
elif cycle == '2019052000':
#  fhrs = np.arange(12,36,3)
   fhrs = np.arange(12,25,1)
#  fhrs = np.arange(18,25,1)
elif cycle == '2019052001':
   fhrs = np.arange(17,19,1)
elif cycle == '2019052002':
   fhrs = np.arange(16,19,1)
elif cycle == '2019052003':
   fhrs = np.arange(15,19,1)
elif cycle == '2019052004':
   fhrs = np.arange(14,19,1)
elif cycle == '2019052005':
   fhrs = np.arange(13,19,1)

elif cycle == '2019052006':
   fhrs = np.arange(12,19,1)
elif cycle == '2019052007':
   fhrs = np.arange(11,18,1)
elif cycle == '2019052008':
   fhrs = np.arange(10,17,1)
elif cycle == '2019052009':
   fhrs = np.arange(9,16,1)
elif cycle == '2019052010':
   fhrs = np.arange(8,15,1)
elif cycle == '2019052011':
   fhrs = np.arange(7,14,1)


elif cycle == '2019052012':
#  fhrs = np.arange(0,25,3)
   fhrs = np.arange(0,13,1)
#  fhrs = np.arange(6,7,1)
#  fhrs = np.arange(6,13,1)
elif cycle == '2019052013':
   fhrs = np.arange(5,12,1)
elif cycle == '2019052014':
   fhrs = np.arange(4,11,1)
elif cycle == '2019052015':
   fhrs = np.arange(3,10,1)
elif cycle == '2019052016':
   fhrs = np.arange(2,9,1)
elif cycle == '2019052017':
   fhrs = np.arange(1,8,1)
elif cycle == '2019052018':
   fhrs = np.arange(0,7,1)
...
elif cycle == '2020020700':
   fhrs = np.arange(11,17,1)
elif cycle == '2020020704':
   fhrs = np.arange(7,13,1)
elif cycle == '2020020705':
   fhrs = np.arange(6,12,1)
elif cycle == '2020020706':
   fhrs = np.arange(5,11,1)
elif cycle == '2020020707':
   fhrs = np.arange(4,10,1)
elif cycle == '2020020708':
   fhrs = np.arange(3,9,1)
elif cycle == '2020020709':
   fhrs = np.arange(2,8,1)
elif cycle == '2020020710':
   fhrs = np.arange(1,7,1)
elif cycle == '2020020711':
   fhrs = np.arange(0,6,1)


fhrs = [0,6,24,36,60]

#fhrs = [120]
#fhrs = np.arange(0,19,1)
...
#  print domain, field 
   ...
   if str.upper(model_str[0:3]) == 'GFS' or str.upper(model_str) == 'EC':
      HLwindow = 25
      if domain in large_domains:
         skip = 10
...
# Plot point markers
   ...
   elif str.upper(model_str[4:]) == 'PROB':
   ...
   plt.text(0, 1.06, mod_str, horizontalalignment='left', transform=ax.transAxes)
   plt.text(0, 1.01, var_str, horizontalalignment='left', transform=ax.transAxes)

   if fhrs[j] != 0:
       plt.text(1, 1.06, initstr, horizontalalignment='right', transform=ax.transAxes)
...
#    validstr = date_list[0].strftime('Valid: %HZ %d %b to ')+date_list[j].strftime('%HZ %d %b %Y')  
   ...
   plt.text(1, 1.01, validstr, horizontalalignment='right', transform=ax.transAxes)
...
#     precip = grbs.select(name='Total Precipitation')[0].values/25.4    # first precip message is run-total bucket; second is 1-h bucket
   ...
   if 't2_10mwind' in fields or 'td2_10mwind' in fields: 
