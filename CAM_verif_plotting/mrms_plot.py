...
# REFC Max40 obs
refc_fil = DATA_DIR+'/MergedReflectivityQCComposite_MAX40_'+vtime[0:8]+'-'+vtime[8:10]+'0000_G227.nc' 
nc = netCDF4.Dataset(refc_fil,'r')
refcmax = nc.variables['MergedReflectivityQCComposite'][:]
nc.close()

# REFC ENS_FREQ obs
refc_fil = DATA_DIR+'/MergedReflectivityQCComposite_ENS_FREQ_'+vtime[0:8]+'-'+vtime[8:10]+'0000_G227.nc' 
nc = netCDF4.Dataset(refc_fil,'r')
...
# REFC analyses
refc_fil = DATA_DIR+'/MergedReflectivityQCComposite_Prob_'+vtime[0:8]+'-'+vtime[8:10]+'0000_G227.nc' 
nc = netCDF4.Dataset(refc_fil,'r')
...
# REFD analyses
refd_fil = DATA_DIR+'/SeamlessHSR_Prob_'+vtime[0:8]+'-'+vtime[8:10]+'0000_G227.nc' 
nc = netCDF4.Dataset(refd_fil,'r')
refdprob40 = nc.variables['Prob_SeamlessHSR_ge40'][:]*100.
nc.close()

# RETOP analyses
etop_fil = DATA_DIR+'/EchoTop18_Prob_'+vtime[0:8]+'-'+vtime[8:10]+'0000_G227.nc' 
nc = netCDF4.Dataset(etop_fil,'r')
...
fields = ['refc','refcprob50','refcmax','refcprob30','refcbin30','refd','refdprob40','retop','retopprob30']
domains = ['conus']
